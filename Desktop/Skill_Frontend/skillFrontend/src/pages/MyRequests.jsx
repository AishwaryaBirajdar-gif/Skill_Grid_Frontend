          ...
          <div className="grid gap-6">
            {incomingRequests.length > 0 ? (
              incomingRequests.map((req) => (
                <div
                  key={req.id}
                  className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-all"
                >
                    ...
                    {req.status === 'PENDING' ? (
                      <>
                        <button
                          ...
                          className="bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-emerald-100 transition-all"
                        >
                          <Check size={18} />
                          Accept
                        </button>
                      ...
                      <div className="flex items-center gap-3">
                        <span
                          className={`px-4 py-2 rounded-lg font-black text-xs uppercase tracking-widest ${
                            req.status === 'ACCEPTED'
